...
function draw_windmill(gl, n, u_MvpMatrix, mvpMatrix, u_mode) {
  ...
  // Light Post-------------------------------------------------------
  mvpMatrix.translate(1.5, 0, -2).scale(0.2, 5.0, 0.2);
  gl.uniformMatrix4fv(u_MvpMatrix, false, mvpMatrix.elements);
  gl.drawElements(gl.TRIANGLES, n, gl.UNSIGNED_BYTE, 0);
  mvpMatrix.scale(1/0.2, 1/5.0, 1/0.2).translate(-1.5, -0, 2);

  mvpMatrix.translate(2.3, 2.5, -2).scale(2.0, 0.2, 0.2);
  gl.uniformMatrix4fv(u_MvpMatrix, false, mvpMatrix.elements);
  gl.drawElements(gl.TRIANGLES, n, gl.UNSIGNED_BYTE, 0);
  mvpMatrix.scale(1/2.0, 1/0.2, 1/0.2).translate(-2.3, -2.5, 2);
  
  pushMatrix(mvpMatrix);
  console.log(Math.sin(angle));
  mvpMatrix.translate(Math.sin(angle*0.021)*5, 0, Math.cos(angle*0.021)*5).rotate((angle*1.25)-360,0,1,0).rotate(-20,0,0,1);
  // Car   -------------------------------------------------------
  mvpMatrix.translate(0, 0.1, 0).scale(0.2, 0.3, 1.5);
  gl.uniformMatrix4fv(u_MvpMatrix, false, mvpMatrix.elements);
  gl.drawElements(gl.TRIANGLES, n, gl.UNSIGNED_BYTE, 0);
  mvpMatrix.scale(1/0.2, 1/0.3, 1/1.5).translate(0, -1.0, 0);
  // wings
  mvpMatrix.translate(0.3, 1.0, 0.2).scale(0.7, 0.1, 0.2);
  gl.uniformMatrix4fv(u_MvpMatrix, false, mvpMatrix.elements);
  gl.drawElements(gl.TRIANGLES, n, gl.UNSIGNED_BYTE, 0);
  mvpMatrix.scale(1/0.7, 1/0.1, 1/0.2).translate(-0.3, -1.0, -0.2);
  ...
  mvpMatrix.scale(1/0.7, 1/0.1, 1/0.2).translate(0.3, -1.0, -0.2);
  // tail vertical
  mvpMatrix.translate(0, 1.2, -0.4).rotate(-20,1,0,0).scale(0.1, 0.4, 0.2);
  gl.uniformMatrix4fv(u_MvpMatrix, false, mvpMatrix.elements);
  gl.drawElements(gl.TRIANGLES, n, gl.UNSIGNED_BYTE, 0);
  mvpMatrix.scale(1/0.1, 1/0.4, 1/0.2).rotate(20,1,0,0).translate(-0, -1.2, 0.4);
  // tail Horzontal
  mvpMatrix.translate(0, 1.4, -0.5).scale(0.6, 0.1, 0.2);
  gl.uniformMatrix4fv(u_MvpMatrix, false, mvpMatrix.elements);
  gl.drawElements(gl.TRIANGLES, n, gl.UNSIGNED_BYTE, 0);
  mvpMatrix.scale(1/0.6, 1/0.1, 1/0.2).translate(-0, -1.4, 0.5);
